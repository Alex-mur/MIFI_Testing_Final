package fun.justdevelops.android;

import fun.justdevelops.driver.TestDriverFactory;
import fun.justdevelops.pages.WikipediaAndroidPage;
...
public class WikipediaAndroidTests {

    private AndroidDriver driver;
    private WikipediaAndroidPage appPage;

    @BeforeMethod
    public void setup() throws Exception {
        driver = TestDriverFactory.createAndroidDriver();
        appPage = new WikipediaAndroidPage(driver);
        Thread.sleep(3000);
    }
    ...
    @Test(priority = 3)
    public void testSearchAndNavigateBack() throws Exception {
