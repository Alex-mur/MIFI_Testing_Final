package fun.justdevelops.pages;
...
public class WikipediaAndroidPage {

    private final AndroidDriver driver;
    private final WebDriverWait wait;

    private final By SEARCH_CONTAINER = By.id("org.wikipedia:id/search_container");
    private final By SEARCH_INPUT_FIELD = By.id("org.wikipedia:id/search_src_text");
    private final By FIRST_RESULT_TITLE = By.id("org.wikipedia:id/page_list_item_title");
    private final By NAVIGATE_UP_BUTTON = AppiumBy.accessibilityId("Navigate up");
    private final By SKIP_BUTTON = By.id("org.wikipedia:id/fragment_onboarding_skip_button");
    private final By CLOSE_POPUP_BUTTON = By.id("org.wikipedia:id/closeButton");

    public WikipediaAndroidPage(AndroidDriver driver) {
        this.driver = driver;
    ...
    public void searchForArticle(String query) throws Exception {
        try {
            skipOnboarding();
            Thread.sleep(2000);
